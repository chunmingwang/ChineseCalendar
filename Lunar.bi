...
Type Lunar
	...
	WeekNameFull(7) As WString Ptr = {@" * ", @"星期日", @"星期一", @"星期二", @"星期三", @"星期四", @"星期五", @"星期六"}
	WeekName(7) As WString Ptr = {@" * ", @"日", @"一", @"二", @"三", @"四", @"五", @"六"}
	nStr1(11) As WString Ptr = {@"日", @"一", @"二", @"三", @"四", @"五", @"六", @"七", @"八", @"九", @"十"}
	nStr2(3) As WString Ptr = {@"初", @"十", @"廿", @"卅"}
	lMonthName(12) As WString Ptr = {@"*", @"正月", @"二月", @"三月", @"四月", @"五月", @"六月", @"七月", @"八月", @"九月", @"十月", @"十一月", @"腊月"}
	sMonthName(12) As WString Ptr = {@"*", @"一月", @"二月", @"三月", @"四月", @"五月", @"六月", @"七月", @"八月", @"九月", @"十月", @"十一月", @"十二月"}
	Gan(10) As WString Ptr = {@"甲", @"乙", @"丙", @"丁", @"戊", @"己", @"庚", @"辛", @"壬", @"癸"}
	Zhi(11) As WString Ptr = {@"子", @"丑", @"寅", @"卯", @"辰", @"巳", @"午", @"未", @"申", @"酉", @"戌", @"亥"}
	Animals(11) As WString Ptr = {@"鼠", @"牛", @"虎", @"兔", @"龙", @"蛇", @"马", @"羊", @"猴", @"鸡", @"狗", @"猪"}
	SolarTerm(23) As WString Ptr = {@"小寒", @"大寒", @"立春", @"雨水", @"惊蛰", @"春分", @"清明", @"谷雨", @"立夏", @"小满", @"芒种", @"夏至", @"小暑", @"大暑", @"立秋", @"处暑", @"白露", @"秋分", @"寒露", @"霜降", @"立冬", @"小雪", @"大雪", @"冬至"}
	...
	Declare Function GanZhi(y As Integer) As UString                     '传回农历y年天干地支
	Declare Function YearAttribute(y As Integer) ByRef As WString              '传回农历y年生肖
	Declare Property lSolarTerm() ByRef As WString                             '节气
	Declare Property wHoliday() ByRef As WString                               '星期节日
	Declare Property lHoliday() ByRef As WString                               '农历节日
	Declare Property sHoliday() ByRef As WString                               '公历节日
	Declare Function lDayName(d As Integer) As UString                   '农历日期名
End Type
